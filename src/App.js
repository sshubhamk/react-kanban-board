...
function App() {
  const [sections, setSections] = useState([
    { id: UtilityFunctions.generateId(), title: 'Backlogs' },
    { id: UtilityFunctions.generateId(), title: 'To Do' },
    { id: UtilityFunctions.generateId(), title: 'In Progress' },
    { id: UtilityFunctions.generateId(), title: 'Done' },
  ]);
      ...
      <div style={mainContainerStyle}>
        <div style={flexEndStyle}>
          {projectName.length > 0 && (
            <h1 style={projectTitleStyle}>{projectName}</h1>
          )}
